...
<div class="container">
    ...
    <div class="col-12 col-lg-9 product-thumb-slide" id="productGallery">
        ...
        <div class="gallery-tab-product">
                <div class="preProduct">
                    ...
                    <img id="u" src="image/kiddie-front.jpg" alt="">
                </div>

                <div class="images">
                    <img onclick="changegambar(this)" src="image/kiddie-front.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/kiddie-product.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/kiddie-texture1.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/kiddie-texture2.jpg" alt="">
                </div>
            </div>
    ...
    <div class="alga-classic-banner" id="overview" style="height:83vh;">
        <img src="image/kiddie-product.jpg" alt="">
    </div>
    ...
    <div class="swiper productBanner">
      <div class="swiper-wrapper productWrapper">
        <div class="swiper-slide productSlide">
          ...
          <img src="image/kiddie-front.jpg" />
        </div>
        <div class="swiper-slide productSlide">
          <div class="overlayProduct"></div>
          <img src="image/kiddie-product.jpg" />
        </div>
      </div>
    ...
    <div class="comfortNaraBox">
        <img src="image/kiddie-banner.jpg" alt="">
    </div>
</div>
