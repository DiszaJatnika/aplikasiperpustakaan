    ...
    <div class="col-12 col-lg-9 product-thumb-slide" id="productGallery">
        ...
        <div class="gallery-tab-product">
                <div class="preProduct">
                    ...
                    <img id="u" src="image/kvJullie.jpg" alt="">
                </div>

                <div class="images">
                    <img onclick="changegambar(this)" src="image/kvJullie.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/jullie-front.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/jullie-product.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/jullie-texture.jpg" alt="">
                </div>
            </div>
...
<div class="comfortNara">
    ...
    <!--        <h1>Smart mattress shopping made easy</h1>-->
