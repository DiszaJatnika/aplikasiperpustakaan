...
<div class="container">
    ...
    <div class="col-12 col-lg-9 product-thumb-slide" id="productGallery">
        ...
        <div class="gallery-tab-product">
                <div class="preProduct">
                    ...
                    <img id="u" src="image/comfort-banner.jpg" alt="">
                </div>

                <div class="images">
                    <img onclick="changegambar(this)" src="image/comfort-banner.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/comfort-front.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/comfort-product.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/comfort-texture.jpg" alt="">
                </div>
            </div>
    ...
    <div class="alga-classic-banner" id="overview"> 
        <img src="image/comfort-model.jpg" alt="">
    </div>
    ...
    <div class="swiper productBanner">
      <div class="swiper-wrapper productWrapper">
        <div class="swiper-slide productSlide">
          ...
          <img src="image/comfort-banner.jpg" />
        </div>
        <div class="swiper-slide productSlide">
          <div class="overlayProduct"></div>
          <img src="image/comfort-model.jpg" />
        </div>
      </div>
