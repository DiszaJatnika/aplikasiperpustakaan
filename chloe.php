    ...
    <div class="product-panel">
        ...
        <div class="gallery-tab-product">
                <div class="preProduct">
                    ...
                    <img id="u" src="image/kvChloe.jpg" alt="">
                </div>

                <div class="images">
                    <img onclick="changegambar(this)" src="image/kvChloe.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/chloe-front.jpg" alt=""> 
                    <img onclick="changegambar(this)" src="image/chloe-product.jpg" alt="">
                    <img onclick="changegambar(this)" src="image/texture-chloe.jpg" alt=""> 
                </div>
            </div>
        ...
        <div class="product-icon">
            ...
            <div class="product-box">
                <span>Free mattress removal</span><br/>
                <a href="#">Learn More</a>
            </div>
        </div>
    </div>
...
<!--<div class="specifications-faq" id="specs">-->
<!--    <div class="faq-button">-->
<!--        <button class="faqlink faqActive" onclick="openFaq(event,'Specifications')">Specifications</button> -->
<!--        <span>/</span>-->
<!--        <button class="faqlink" onclick="openFaq(event,'Faq')">FAQs</button>-->
<!--    </div>-->
...
<!--    </div>-->
    ...
    <!-- SECTION Smart mattress shopping made easy -->
    <!--<div class="excessIcon">-->
    <!--        <div class="excessIconBox">-->
    <!--            <div class="excessBox">-->
    <!--                <div class="excessBoxImage">-->
    ...
    <!--            <div class="excessBox">-->
    <!--                <div class="excessBoxImage">-->
    <!--                    <img src="image/icon/call-center.png" alt="">-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--</div>-->
    <!-- END SECTION Smart mattress shopping made easy -->

    <!-- Upgrade your sleep sanctuary -->
    
    <!-- END Upgrade your sleep sanctuary -->
